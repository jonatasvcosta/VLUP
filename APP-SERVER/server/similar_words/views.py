...
def index(request):
    if request.method == 'POST':
        ...
        original_text, original_language, final_language = similar_words_element.original_text, similar_words_element.original_language, translatedsimilar_words_element_element.final_language
